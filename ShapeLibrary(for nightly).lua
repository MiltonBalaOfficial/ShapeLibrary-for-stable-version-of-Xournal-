...
function insert_stroke(shape_name)
    local filepath = sourcePath .. "Shapes" .. sep .. shape_name .. ".lua" -- Path of the shape
    ...
    if strokes and #strokes > 0 then
        ...
        app.refreshPage()
        app.addToSelection(refs) -- This make the incerted strokes selected, so that the shape can be moved easily after incerted.
